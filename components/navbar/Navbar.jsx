...
const Navbar = () => {
    ...
    return (
        <>
            ...
            {/* <nav className={`w-full shadow sticky  top-0 `} style={{ zIndex:"999", background:(navbar?"linear-gradient(90deg, #0ed5fa, #684cb1)":"white"),}} > */}
            <nav className={`w-full shadow sticky  top-0 bg-white `} style={{ zIndex:"999"}} >
                <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                    <div>
                        <div className="flex items-center justify-between py-3 md:py-5 md:block">
                            <Link href="/">
                                <img src="/logoipsum-225.svg" width={"50px"} alt="" />
                            </Link>
