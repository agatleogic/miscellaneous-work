    ...
    <>
      <section className="text-gray-200 body-font">
        <div className="container mx-auto flex px-5 py-16 lg:flex-row flex-col items-center gap-4">
          ...
          <Image  className="rounded lg:max-w-2xl lg:w-full md:w-full w-5/6 hover:scale-110 transition duration-300 ease-in-out"
              alt="hero" src="/images/skills-img.png" width="500" height="400" ></Image> 
